...
export const METHODOLOGY_STAGES: MethodologyStage[] = [
  ...
  },
  {
    ...
    keyActions: [
      ...
      "Executive reporting and health dashboard activation",
    ],
    deliverables: [
      "Certified Workforce with Interactive AI Coach",
      "Executive Reporting & Health Dashboard",
  ...
  },
  {
    ...
    tagline: "Continuous performance monitoring & system scaling",
    objective: "We maintain 24/7 performance monitoring, perform quarterly prompt and model fine-tuning, and expand agent systems to adjacent business units.",
    icon: RefreshCw,
    keyActions: [
      "24/7 accuracy, latency, and error rate tracking",
      "Quarterly model evaluations and automated prompt regression tests",
      "Multi-agent expansion into adjacent departments",
